...
class Atri:
	def __init__(self, state: Any):
		...
		self.mainflex1 = state["mainflex1"]
		self.logoflex1 = state["logoflex1"]
		self.homediv = state["homediv"]
		self.menudiv = state["menudiv"]
		self.pagesdiv = state["pagesdiv"]
		self.cartdiv = state["cartdiv"]
		self.reservatediv = state["reservatediv"]
		self.orderonlinediv = state["orderonlinediv"]
		self.about_Div = state["about_Div"]
		...
		self.homemenuflex = state["homemenuflex"]
		self.Flex27 = state["Flex27"]
		self.Flex34 = state["Flex34"]
		self.Flex35 = state["Flex35"]
		self.Flex36 = state["Flex36"]
		self.Flex37 = state["Flex37"]
		self.aboutflex39 = state["aboutflex39"]
		self.aboutimageflex40 = state["aboutimageflex40"]
		self.aboutaddrFlex42 = state["aboutaddrFlex42"]
		self.addressFlex58 = state["addressFlex58"]
		self.Flex60 = state["Flex60"]
		self.Flex80 = state["Flex80"]
		self.aboutFlex48 = state["aboutFlex48"]
		self.aboutFlex54 = state["aboutFlex54"]
		...
		self.testimonialFlex127 = state["testimonialFlex127"]
		self.feedbackFlex134 = state["feedbackFlex134"]
		self.Flex137 = state["Flex137"]
		self.Flex138 = state["Flex138"]
		self.maintestiFlex139 = state["maintestiFlex139"]
		self.Flex141 = state["Flex141"]
		self.Flex148 = state["Flex148"]
		self.Flex153 = state["Flex153"]
		self.Flex154 = state["Flex154"]
		self.articlesFlex162 = state["articlesFlex162"]
		self.ourarticlesFlex164 = state["ourarticlesFlex164"]
		self.Flex222 = state["Flex222"]
		self.Flex182 = state["Flex182"]
		self.articlessFlex183 = state["articlessFlex183"]
		...
		self.Carousel4 = state["Carousel4"]
		...
		self.menutextdesc = state["menutextdesc"]
		self.browsemenutextBox14 = state["browsemenutextBox14"]
		self.MenutextBox15 = state["MenutextBox15"]
		self.menutextBox16 = state["menutextBox16"]
		...
		self.aboutImage27 = state["aboutImage27"]
		self.aboutTextBox42 = state["aboutTextBox42"]
		self.Image28 = state["Image28"]
		self.addressTextBox43 = state["addressTextBox43"]
		self.TextBox45 = state["TextBox45"]
		self.Image30 = state["Image30"]
		self.Image38 = state["Image38"]
		self.TextBox56 = state["TextBox56"]
		self.aboutTextBox38 = state["aboutTextBox38"]
		self.aboutTextBox39 = state["aboutTextBox39"]
		self.aboutTextBox40 = state["aboutTextBox40"]
		self.aboutButton11 = state["aboutButton11"]
		self.aboutButton12 = state["aboutButton12"]
		self.menuTextBox55 = state["menuTextBox55"]
		self.menuTextBox57 = state["menuTextBox57"]
		self.meImage55 = state["meImage55"]
		self.TextBox100 = state["TextBox100"]
		self.TextBox101 = state["TextBox101"]
		self.classicTextBox102 = state["classicTextBox102"]
		...
		self.leftarrowImage73 = state["leftarrowImage73"]
	...
	@property
	def mainflex1(self):
		self._getter_access_tracker["mainflex1"] = {}
		return self._mainflex1
	@mainflex1.setter
	def mainflex1(self, new_state):
		self._setter_access_tracker["mainflex1"] = {}
		global default_state
		self._mainflex1 = Flex(new_state, default_state["mainflex1"])

	@property
	def logoflex1(self):
		self._getter_access_tracker["logoflex1"] = {}
		return self._logoflex1
	@logoflex1.setter
	def logoflex1(self, new_state):
		self._setter_access_tracker["logoflex1"] = {}
		global default_state
		self._logoflex1 = Flex(new_state, default_state["logoflex1"])

	@property
	def homediv(self):
		self._getter_access_tracker["homediv"] = {}
		return self._homediv
	@homediv.setter
	def homediv(self, new_state):
		self._setter_access_tracker["homediv"] = {}
		global default_state
		self._homediv = Div(new_state, default_state["homediv"])

	@property
	def menudiv(self):
		self._getter_access_tracker["menudiv"] = {}
		return self._menudiv
	@menudiv.setter
	def menudiv(self, new_state):
		self._setter_access_tracker["menudiv"] = {}
		global default_state
		self._menudiv = Div(new_state, default_state["menudiv"])

	@property
	def pagesdiv(self):
		self._getter_access_tracker["pagesdiv"] = {}
		return self._pagesdiv
	@pagesdiv.setter
	def pagesdiv(self, new_state):
		self._setter_access_tracker["pagesdiv"] = {}
		global default_state
		self._pagesdiv = Div(new_state, default_state["pagesdiv"])

	@property
	def cartdiv(self):
		self._getter_access_tracker["cartdiv"] = {}
		return self._cartdiv
	@cartdiv.setter
	def cartdiv(self, new_state):
		self._setter_access_tracker["cartdiv"] = {}
		global default_state
		self._cartdiv = Div(new_state, default_state["cartdiv"])

	@property
	def reservatediv(self):
		self._getter_access_tracker["reservatediv"] = {}
		return self._reservatediv
	@reservatediv.setter
	def reservatediv(self, new_state):
		self._setter_access_tracker["reservatediv"] = {}
		global default_state
		self._reservatediv = Div(new_state, default_state["reservatediv"])

	@property
	def orderonlinediv(self):
		self._getter_access_tracker["orderonlinediv"] = {}
		return self._orderonlinediv
	@orderonlinediv.setter
	def orderonlinediv(self, new_state):
		self._setter_access_tracker["orderonlinediv"] = {}
		global default_state
		self._orderonlinediv = Div(new_state, default_state["orderonlinediv"])

	@property
	def about_Div(self):
		self._getter_access_tracker["about_Div"] = {}
		return self._about_Div
	@about_Div.setter
	def about_Div(self, new_state):
		self._setter_access_tracker["about_Div"] = {}
		global default_state
		self._about_Div = Div(new_state, default_state["about_Div"])
	...
	@property
	def homemenuflex(self):
		self._getter_access_tracker["homemenuflex"] = {}
		return self._homemenuflex
	@homemenuflex.setter
	def homemenuflex(self, new_state):
		self._setter_access_tracker["homemenuflex"] = {}
		global default_state
		self._homemenuflex = Flex(new_state, default_state["homemenuflex"])
	...
	@property
	def aboutflex39(self):
		self._getter_access_tracker["aboutflex39"] = {}
		return self._aboutflex39
	@aboutflex39.setter
	def aboutflex39(self, new_state):
		self._setter_access_tracker["aboutflex39"] = {}
		global default_state
		self._aboutflex39 = Flex(new_state, default_state["aboutflex39"])

	@property
	def aboutimageflex40(self):
		self._getter_access_tracker["aboutimageflex40"] = {}
		return self._aboutimageflex40
	@aboutimageflex40.setter
	def aboutimageflex40(self, new_state):
		self._setter_access_tracker["aboutimageflex40"] = {}
		global default_state
		self._aboutimageflex40 = Flex(new_state, default_state["aboutimageflex40"])

	@property
	def aboutaddrFlex42(self):
		self._getter_access_tracker["aboutaddrFlex42"] = {}
		return self._aboutaddrFlex42
	@aboutaddrFlex42.setter
	def aboutaddrFlex42(self, new_state):
		self._setter_access_tracker["aboutaddrFlex42"] = {}
		global default_state
		self._aboutaddrFlex42 = Flex(new_state, default_state["aboutaddrFlex42"])

	@property
	def addressFlex58(self):
		self._getter_access_tracker["addressFlex58"] = {}
		return self._addressFlex58
	@addressFlex58.setter
	def addressFlex58(self, new_state):
		self._setter_access_tracker["addressFlex58"] = {}
		global default_state
		self._addressFlex58 = Flex(new_state, default_state["addressFlex58"])
	...
	@property
	def aboutFlex48(self):
		self._getter_access_tracker["aboutFlex48"] = {}
		return self._aboutFlex48
	@aboutFlex48.setter
	def aboutFlex48(self, new_state):
		self._setter_access_tracker["aboutFlex48"] = {}
		global default_state
		self._aboutFlex48 = Flex(new_state, default_state["aboutFlex48"])

	@property
	def aboutFlex54(self):
		self._getter_access_tracker["aboutFlex54"] = {}
		return self._aboutFlex54
	@aboutFlex54.setter
	def aboutFlex54(self, new_state):
		self._setter_access_tracker["aboutFlex54"] = {}
		global default_state
		self._aboutFlex54 = Flex(new_state, default_state["aboutFlex54"])
	...
	@property
	def testimonialFlex127(self):
		self._getter_access_tracker["testimonialFlex127"] = {}
		return self._testimonialFlex127
	@testimonialFlex127.setter
	def testimonialFlex127(self, new_state):
		self._setter_access_tracker["testimonialFlex127"] = {}
		global default_state
		self._testimonialFlex127 = Flex(new_state, default_state["testimonialFlex127"])

	@property
	def feedbackFlex134(self):
		self._getter_access_tracker["feedbackFlex134"] = {}
		return self._feedbackFlex134
	@feedbackFlex134.setter
	def feedbackFlex134(self, new_state):
		self._setter_access_tracker["feedbackFlex134"] = {}
		global default_state
		self._feedbackFlex134 = Flex(new_state, default_state["feedbackFlex134"])
	...
	@property
	def maintestiFlex139(self):
		self._getter_access_tracker["maintestiFlex139"] = {}
		return self._maintestiFlex139
	@maintestiFlex139.setter
	def maintestiFlex139(self, new_state):
		self._setter_access_tracker["maintestiFlex139"] = {}
		global default_state
		self._maintestiFlex139 = Flex(new_state, default_state["maintestiFlex139"])
	...
	@property
	def articlesFlex162(self):
		self._getter_access_tracker["articlesFlex162"] = {}
		return self._articlesFlex162
	@articlesFlex162.setter
	def articlesFlex162(self, new_state):
		self._setter_access_tracker["articlesFlex162"] = {}
		global default_state
		self._articlesFlex162 = Flex(new_state, default_state["articlesFlex162"])

	@property
	def ourarticlesFlex164(self):
		self._getter_access_tracker["ourarticlesFlex164"] = {}
		return self._ourarticlesFlex164
	@ourarticlesFlex164.setter
	def ourarticlesFlex164(self, new_state):
		self._setter_access_tracker["ourarticlesFlex164"] = {}
		global default_state
		self._ourarticlesFlex164 = Flex(new_state, default_state["ourarticlesFlex164"])
	...
	@property
	def articlessFlex183(self):
		self._getter_access_tracker["articlessFlex183"] = {}
		return self._articlessFlex183
	@articlessFlex183.setter
	def articlessFlex183(self, new_state):
		self._setter_access_tracker["articlessFlex183"] = {}
		global default_state
		self._articlessFlex183 = Flex(new_state, default_state["articlessFlex183"])
	...
	@property
	def Carousel4(self):
		self._getter_access_tracker["Carousel4"] = {}
		return self._Carousel4
	@Carousel4.setter
	def Carousel4(self, new_state):
		self._setter_access_tracker["Carousel4"] = {}
		global default_state
		self._Carousel4 = Carousel(new_state, default_state["Carousel4"])
	...
	@property
	def menutextdesc(self):
		self._getter_access_tracker["menutextdesc"] = {}
		return self._menutextdesc
	@menutextdesc.setter
	def menutextdesc(self, new_state):
		self._setter_access_tracker["menutextdesc"] = {}
		global default_state
		self._menutextdesc = TextBox(new_state, default_state["menutextdesc"])

	@property
	def browsemenutextBox14(self):
		self._getter_access_tracker["browsemenutextBox14"] = {}
		return self._browsemenutextBox14
	@browsemenutextBox14.setter
	def browsemenutextBox14(self, new_state):
		self._setter_access_tracker["browsemenutextBox14"] = {}
		global default_state
		self._browsemenutextBox14 = TextBox(new_state, default_state["browsemenutextBox14"])

	@property
	def MenutextBox15(self):
		self._getter_access_tracker["MenutextBox15"] = {}
		return self._MenutextBox15
	@MenutextBox15.setter
	def MenutextBox15(self, new_state):
		self._setter_access_tracker["MenutextBox15"] = {}
		global default_state
		self._MenutextBox15 = TextBox(new_state, default_state["MenutextBox15"])

	@property
	def menutextBox16(self):
		self._getter_access_tracker["menutextBox16"] = {}
		return self._menutextBox16
	@menutextBox16.setter
	def menutextBox16(self, new_state):
		self._setter_access_tracker["menutextBox16"] = {}
		global default_state
		self._menutextBox16 = TextBox(new_state, default_state["menutextBox16"])
	...
	@property
	def aboutImage27(self):
		self._getter_access_tracker["aboutImage27"] = {}
		return self._aboutImage27
	@aboutImage27.setter
	def aboutImage27(self, new_state):
		self._setter_access_tracker["aboutImage27"] = {}
		global default_state
		self._aboutImage27 = Image(new_state, default_state["aboutImage27"])

	@property
	def aboutTextBox42(self):
		self._getter_access_tracker["aboutTextBox42"] = {}
		return self._aboutTextBox42
	@aboutTextBox42.setter
	def aboutTextBox42(self, new_state):
		self._setter_access_tracker["aboutTextBox42"] = {}
		global default_state
		self._aboutTextBox42 = TextBox(new_state, default_state["aboutTextBox42"])
	...
	@property
	def addressTextBox43(self):
		self._getter_access_tracker["addressTextBox43"] = {}
		return self._addressTextBox43
	@addressTextBox43.setter
	def addressTextBox43(self, new_state):
		self._setter_access_tracker["addressTextBox43"] = {}
		global default_state
		self._addressTextBox43 = TextBox(new_state, default_state["addressTextBox43"])
	...
	@property
	def aboutTextBox38(self):
		self._getter_access_tracker["aboutTextBox38"] = {}
		return self._aboutTextBox38
	@aboutTextBox38.setter
	def aboutTextBox38(self, new_state):
		self._setter_access_tracker["aboutTextBox38"] = {}
		global default_state
		self._aboutTextBox38 = TextBox(new_state, default_state["aboutTextBox38"])

	@property
	def aboutTextBox39(self):
		self._getter_access_tracker["aboutTextBox39"] = {}
		return self._aboutTextBox39
	@aboutTextBox39.setter
	def aboutTextBox39(self, new_state):
		self._setter_access_tracker["aboutTextBox39"] = {}
		global default_state
		self._aboutTextBox39 = TextBox(new_state, default_state["aboutTextBox39"])

	@property
	def aboutTextBox40(self):
		self._getter_access_tracker["aboutTextBox40"] = {}
		return self._aboutTextBox40
	@aboutTextBox40.setter
	def aboutTextBox40(self, new_state):
		self._setter_access_tracker["aboutTextBox40"] = {}
		global default_state
		self._aboutTextBox40 = TextBox(new_state, default_state["aboutTextBox40"])

	@property
	def aboutButton11(self):
		self._getter_access_tracker["aboutButton11"] = {}
		return self._aboutButton11
	@aboutButton11.setter
	def aboutButton11(self, new_state):
		self._setter_access_tracker["aboutButton11"] = {}
		global default_state
		self._aboutButton11 = Button(new_state, default_state["aboutButton11"])

	@property
	def aboutButton12(self):
		self._getter_access_tracker["aboutButton12"] = {}
		return self._aboutButton12
	@aboutButton12.setter
	def aboutButton12(self, new_state):
		self._setter_access_tracker["aboutButton12"] = {}
		global default_state
		self._aboutButton12 = Button(new_state, default_state["aboutButton12"])

	@property
	def menuTextBox55(self):
		self._getter_access_tracker["menuTextBox55"] = {}
		return self._menuTextBox55
	@menuTextBox55.setter
	def menuTextBox55(self, new_state):
		self._setter_access_tracker["menuTextBox55"] = {}
		global default_state
		self._menuTextBox55 = TextBox(new_state, default_state["menuTextBox55"])

	@property
	def menuTextBox57(self):
		self._getter_access_tracker["menuTextBox57"] = {}
		return self._menuTextBox57
	@menuTextBox57.setter
	def menuTextBox57(self, new_state):
		self._setter_access_tracker["menuTextBox57"] = {}
		global default_state
		self._menuTextBox57 = TextBox(new_state, default_state["menuTextBox57"])

	@property
	def meImage55(self):
		self._getter_access_tracker["meImage55"] = {}
		return self._meImage55
	@meImage55.setter
	def meImage55(self, new_state):
		self._setter_access_tracker["meImage55"] = {}
		global default_state
		self._meImage55 = Image(new_state, default_state["meImage55"])
	...
	@property
	def classicTextBox102(self):
		self._getter_access_tracker["classicTextBox102"] = {}
		return self._classicTextBox102
	@classicTextBox102.setter
	def classicTextBox102(self, new_state):
		self._setter_access_tracker["classicTextBox102"] = {}
		global default_state
		self._classicTextBox102 = TextBox(new_state, default_state["classicTextBox102"])
	...
	@property
	def leftarrowImage73(self):
		self._getter_access_tracker["leftarrowImage73"] = {}
		return self._leftarrowImage73
	@leftarrowImage73.setter
	def leftarrowImage73(self, new_state):
		self._setter_access_tracker["leftarrowImage73"] = {}
		global default_state
		self._leftarrowImage73 = Image(new_state, default_state["leftarrowImage73"])
	...
	def _to_json_fields(self):
		return {
			...
			"mainflex1": self._mainflex1,
			"logoflex1": self._logoflex1,
			"homediv": self._homediv,
			"menudiv": self._menudiv,
			"pagesdiv": self._pagesdiv,
			"cartdiv": self._cartdiv,
			"reservatediv": self._reservatediv,
			"orderonlinediv": self._orderonlinediv,
			"about_Div": self._about_Div,
			"Flex22": self._Flex22,
			"Flex23": self._Flex23,
			"Div47": self._Div47,
			"Div48": self._Div48,
			...
			"Flex24": self._Flex24,
			"Div52": self._Div52,
			"homemenuflex": self._homemenuflex,
			"Flex27": self._Flex27,
			"Flex34": self._Flex34,
			"Flex35": self._Flex35,
			"Flex36": self._Flex36,
			"Flex37": self._Flex37,
			"aboutflex39": self._aboutflex39,
			"aboutimageflex40": self._aboutimageflex40,
			"aboutaddrFlex42": self._aboutaddrFlex42,
			"addressFlex58": self._addressFlex58,
			"Flex60": self._Flex60,
			"Flex80": self._Flex80,
			"aboutFlex48": self._aboutFlex48,
			"aboutFlex54": self._aboutFlex54,
			"Flex73": self._Flex73,
			...
			"testimonialFlex127": self._testimonialFlex127,
			"feedbackFlex134": self._feedbackFlex134,
			"Flex137": self._Flex137,
			"Flex138": self._Flex138,
			"maintestiFlex139": self._maintestiFlex139,
			"Flex141": self._Flex141,
			"Flex148": self._Flex148,
			"Flex153": self._Flex153,
			"Flex154": self._Flex154,
			"articlesFlex162": self._articlesFlex162,
			"ourarticlesFlex164": self._ourarticlesFlex164,
			"Flex222": self._Flex222,
			"Flex182": self._Flex182,
			"articlessFlex183": self._articlessFlex183,
			...
			"menutextdesc": self._menutextdesc,
			"browsemenutextBox14": self._browsemenutextBox14,
			"MenutextBox15": self._MenutextBox15,
			"menutextBox16": self._menutextBox16,
			...
			"aboutImage27": self._aboutImage27,
			"aboutTextBox42": self._aboutTextBox42,
			"Image28": self._Image28,
			"addressTextBox43": self._addressTextBox43,
			"TextBox45": self._TextBox45,
			"Image30": self._Image30,
			"Image38": self._Image38,
			"TextBox56": self._TextBox56,
			"aboutTextBox38": self._aboutTextBox38,
			"aboutTextBox39": self._aboutTextBox39,
			"aboutTextBox40": self._aboutTextBox40,
			"aboutButton11": self._aboutButton11,
			"aboutButton12": self._aboutButton12,
			"menuTextBox55": self._menuTextBox55,
			"menuTextBox57": self._menuTextBox57,
			"meImage55": self._meImage55,
			"TextBox100": self._TextBox100,
			"TextBox101": self._TextBox101,
			"classicTextBox102": self._classicTextBox102,
			...
			"leftarrowImage73": self._leftarrowImage73,
